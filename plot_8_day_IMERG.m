function R = plot_8_day_IMERG(prec_threshold, grid_IMERG_8days, VOSTOK_hour_8days)
...
for day = 1:8
    for hour = 1:24
        ...
        DD(hour, 1, day) = length(find(hour_grid > prec_threshold));
...
title_str = strcat("Cell covered with at least ", num2str(prec_threshold), " mm/hr precipitation and R = ", num2str(R));
title(title_str)
end
% fill example
% x = 1 : 24;
